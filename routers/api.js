...
apiRouterSecure.route("/movies").post(authorize,validator.movieCreate,movieController.create);
...
apiRouterSecure.route("/theaters").post(authorizeRoles(['admin','client']),validator.theaterCreate, theaterController.create);
...
apiRouterSecure.route("/theaters/:id/movies").put(authorizeRoles(['client']),validator.theaterSetMovies,theaterController.setMovies);
